...
import os
import sys
src_path = os.path.abspath('../src/brainview')
...
htmlhelp_basename = 'brainviewdoc'
...
latex_documents = [
    (master_doc, 'brainview.tex', u'brainview Documentation',
...
man_pages = [
    (master_doc, 'brainview', u'brainview Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'brainview', u'brainview Documentation',
     author, 'brainview', 'Python module to load FreeSurfer neuroimaging data.',
     'Miscellaneous'),
]
